...
npm install @heycharles/javascript-sdk
```
...
```javascript
import * as charles from '@heycharles/javascript-sdk'

// configure which API to use. E.g. you can also run staging and sandbox APIs
charles.init({
  universe: 'https://api.hello-charles.com'
})
...
```javascript
import Auth from '@heycharles/javascript-sdk/dist/lib/Auth'
```
