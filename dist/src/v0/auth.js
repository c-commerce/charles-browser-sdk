    ...
    Auth.prototype.authenticate = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.options.type === AuthTypes.username)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.loginUsername(this.options.credentials)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, axios_1.default.post(((_a = authData.authBaseUrl) !== null && _a !== void 0 ? _a : this.authBaseUrl) + "/api/v0/users/auth/login", {
                                email: username,
                                password: password,
