...
var Me = /** @class */ (function (_super) {
    ...
    function Me(options, http) {
        ...
        _this.options.base = _this.options.base || 'https://api.hello-charles.com';
        return _this;
    }
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        return [2 /*return*/, reject(new MeFetchFailed(undefined, { error: error_1 }))];
...
exports.Me = Me;
var MeFetchFailed = /** @class */ (function (_super) {
    __extends(MeFetchFailed, _super);
    function MeFetchFailed(message, properties) {
        if (message === void 0) { message = 'Could not fetch me.'; }
