...
var Entity = /** @class */ (function (_super) {
    ...
    Entity.prototype.fetch = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._fetch(options)];
                    case 1: 
    ...
    Entity.prototype.patch = function (changePart) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._patch(changePart)];
                    case 1: 
    ...
    Entity.prototype.post = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._post()];
                    case 1: 
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ((_c = this.http) === null || _c === void 0 ? void 0 : _c.getClient()(opts))];
                    case 1:
                        response = _d.sent();
                        this.deserialize(response.data.data[0]);
                        return [2 /*return*/, this];
    ...
    Entity.prototype.delete = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._delete()];
                    case 1: 
    ...
    Entity.prototype.save = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._save(payload)];
                    case 1: 
    ...
    Entity.prototype._save = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.id && payload)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.patch(payload)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        if (!(!this.id && payload)) return [3 /*break*/, 4];
