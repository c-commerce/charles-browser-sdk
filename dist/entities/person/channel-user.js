            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, event.Event.create(response.data.data[0], _feed, this.universe, this.http)];
                    case 2:
                        err_1 = _a.sent();
...
var PersonChannelUserMessageTemplateSendError = /** @class */ (function (_super) {
